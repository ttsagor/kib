...
<html class="no-js" lang="zxx">
    ...
    <body class="bgimg">
		...
		<div class="section_search">
			<div class="container">
				<div class="row">
					<form role="form" action='<?php echo $target; ?>' method='post' id='frm_final'>
					<div class="col-md-8 col-md-offset-2 search-details box_padding1">
						<div class="col-md-3 box_padding1">
							<div class="col-md-12 col-sm-12 user-image">
								<img class="img-responsive" src="<?php echo base_url().$applicant_photo_path."?".time(); ?>"'/>
							</div>
									...
									<tr>
										<td colspan="4" scope="colgroup">
											<span class="btn_confirm">
												  <Button class="btn btn-primary" onclick='document.getElementById("frm_final").submit()'>Confirm</Button>
											</span>
											<span class="btn_confirm">												
												  <a class="btn btn btn-info" href='<?php echo base_url(); ?>web-member-information-preview'>Back</a>
											</span>
										</td>
									</tr>
								</tbody>
